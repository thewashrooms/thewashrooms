...
<script>
const tracks = [
  { id: 1, title: 'Without You', src: '/assets/downloadmusic/withoutyouv1.mp3' },
  { id: 2, title: 'When You are Around', src: '/assets/downloadmusic/whenyourearound.mp3' },
  { id: 3, title: 'A Dance After Dark', src: '/assets/downloadmusic/adad.mp3' },
  { id: 4, title: 'Too Soon', src: '/assets/downloadmusic/toosoon.mp3' },
  { id: 5, title: 'Never Coming Back', src: '/assets/downloadmusic/nevercomingback.mp3' },
  { id: 6, title: 'Shine', src: '/assets/downloadmusic/shine.mp3' },
  { id: 7, title: 'Without You V2', src: '/assets/downloadmusic/withyouv2.mp3' }
];
