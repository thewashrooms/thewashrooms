...
<script>
const tracks = [
  { id: 1, title: 'Amsterdam', src: '/assets/downloadmusic/amsterdam.mp3' },
  { id: 2, title: 'A Study in Red', src: '/assets/downloadmusic/astudyinred.mp3' },
  { id: 3, title: 'Amsterdam Coda', src: '/assets/downloadmusic/amsterdamcoda' }
];
