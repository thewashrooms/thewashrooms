...
<script>
const tracks = [
  { id: 1, title: 'Strawhead', src: '/assets/downloadmusic/Strawhead.mp3' },
  { id: 2, title: 'Trying to Make Sense of it All', src: '/assets/downloadmusic/Trying-to-Make-Sense-of-it-All.mp3' }
];
